        ...
        <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
            ...
            @can('create_building')
                @if ($create_mode)
                    <div class="grid grid-cols-12 place-content-end">
                        ...
                        <div class="col-start-1 col-end-13 sm:col-start-7 sm:col-end-8 sm:mr-3">
                        ...
                        <div class="col-start-1 col-end-13 sm:col-start-11 sm:mr-3">
                            <x-mary-input label="CEP" wire:model="postal_code" />
                        </div>
                        <div class="col-start-1 col-end-13 sm:col-end-3 sm:mr-3">
                            <x-mary-input label="Latitude" wire:model.live="latitude" wire:change="test"/>
                        </div>
                        <div class="col-start-1 col-end-13 sm:col-start-3 sm:col-end-5 sm:mr-3">
                        ...
                        <div class="col-start-1 col-end-4 sm:col-start-1 sm:col-end-2 mt-2">
            ...
            @can('edit_building')
                @if ($edit_mode)
                    <div class="grid grid-cols-12 place-content-end">
                        ...
                        <div class="col-start-1 col-end-13 sm:col-start-2 sm:col-end-13 sm:ml-3 sm:mr-3">
                            <x-mary-input label="Nome" wire:model="name" />
                        </div>
                        <div class="col-start-1 col-end-13 sm:col-end-7 sm:mr-3">
                            <x-mary-input label="Endereço" wire:model="address" />
            ...
            @if ($show_table)
                <div class="grid grid-cols-12 place-content-end">
                    ...
                    @can('create_building')
                        <div class="col-start-1 sm:col-start-12 col-end-4 sm:col-end-13 mt-2 sm:mt-7">
                    ...
                    @scope('cell_actions', $building)
                        @can('edit_building')
                            <x-mary-button class="btn-warning text-bold btn-sm btn-square sm:w-32 pt-1 sm:pt-0" icon="o-pencil"
                                wire:click="edit({{ $building->id }})"><span class="scale-0 sm:scale-100">Editar</span>
                            </x-mary-button>
                            <x-mary-button class="{{ $building->active ? 'btn-error' : 'btn-success' }} text-bold btn-sm btn-square pt-1 sm:w-32 sm:pt-0"
                                icon="o-arrows-right-left" wire:click="toggle({{ $building->id }})">
                                <span class="scale-0 sm:scale-100">{{ $building->active ? 'Desativar' : 'Ativar' }}</span>
                            </x-mary-button>
                        @endcan
                    @endscope
                </x-mary-table>
